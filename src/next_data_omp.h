...
public:
    ...
    static void calc_bounds(float *min_bounds, float *max_bounds, float *v_coords, int const n_dim,
    ...
    static unsigned long determine_data_boundaries(float *min_bounds, float *max_bounds, float *v_coords,
            int const n_dim, unsigned long const n_coords, float const lowest_e) noexcept {

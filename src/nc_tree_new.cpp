...
unsigned long nc_tree_new::select_partition_dimensions(long const min_sample_size,
...
void nc_tree_new::partition_data(long const min_partitions, unsigned long const n_threads) noexcept {
